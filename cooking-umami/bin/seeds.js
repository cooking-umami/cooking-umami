...
const MONGO_URI =
  ...
  const recipes = [
    ...
    description: "A classic local Hawaiian dish consisting of shrimp pan-fried with plenty of garlic and butter, it's a very popular item amongst Hawaiian food trucks.",
    instructions: ["Clean the shrimp!", "Dress the ingredients!", "Coat it!"],
    cuisine: "Chinese",
  ...
  },
  {
    ...
    description: "A pasta dish known for its layers of meat, cheese, and sauce. Lasagna is also used to refer to the wide, flat pasta used in the dish.",
    instructions: ["Cut the Ingredients", "Stir Fry it!", "Stir it!"],
    cuisine: "Italian",
    dishType: "main-course",
  ...
  },
  {
    ...
    instructions: ["make some popcorn!", "Add some seasoning!"],
    cuisine: "American",
    dishType: "snack",
